                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="persona in arrayPersona" :key="persona.id">
                                    ...
                                    <td v-text="persona.nomusuario"></td>
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                   <label class="col-md-3 form-control-label" for="text-input">1°Nombre</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="pnombre" class="form-control" placeholder="Nombre de la persona">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">2°Nombre</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="snombre" class="form-control" placeholder="Nombre de la persona">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">1°Apellido</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="papellido" class="form-control" placeholder="Nombre de la persona">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">2°Apellido</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="sapellido" class="form-control" placeholder="Nombre de la persona">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Fecha Nacimiento</label>
                                    <div class="col-md-9">
                                        <input type="date" v-model="fechanaci" class="form-control" placeholder="Número de documento">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="idrol">
                                            ...
                                            <option v-for="rol in arrayRol" :key="rol.id" :value="rol.idrol" v-text="rol.nomrol">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="nomusuario" class="form-control" placeholder="Nombre de usuario">
                                    </div>
                                </div>
                                <div class="form-group row">
