        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> Tipo de Documentos
                    <button type="button" @click="abrirModal('tipoDocumento', 'registrar')" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            <tr v-for="tipoDocumento in arrayTipoDocumento" :key="tipoDocumento.idtipodocumento">
                                <td>
                                    <button type="button" @click="abrirModal('tipoDocumento', 'actualizar', tipoDocumento)" class="btn btn-warning btn-sm">
                                      <i class="icon-pencil"></i>
                                    </button> &nbsp;
                                    <template v-if="tipoDocumento.estado=='1'">
                                        <button type="button" class="btn btn-danger btn-sm" @click="desactivarTipoDocumento(tipoDocumento.idtipodocumento)">
                                            <i class="icon-trash"></i>
                                        </button>
                                    </template>
                                    <template v-else>
                                        <button type="button" class="btn btn-info btn-sm" @click="activarTipoDocumento(tipoDocumento.idtipodocumento)">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" v-model="nombre" class="form-control" placeholder="Nombre tipo de documento">
                                </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div v-show="errorTipoDocumento" class="form-group row div-error">
                                <div class="text-center text-error">
                                    <div v-for="error in errorMostrarMsjTipoDocumento" :key=error v-text="error">
...
<script>
    export default {
        ...
        methods: {
            ...
            listarTipoDocumentos(page,buscar,criterio){
                let me=this;
